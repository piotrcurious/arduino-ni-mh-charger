...
void filter_temps() {
  ...
  filtered1 = filter1.updateEstimate(temp1 - ambient_effect, 0.1, 0.1, temp1);
  filtered2 = filter2.updateEstimate(temp2 - ambient_effect, 0.1, 0.1, temp2);
  filtered3 = filter3.updateEstimate(temp3, 0.1, 0.1, temp3);
  ...
  filtered_delta1 = delta1.updateEstimate(delta1, 0.1 * (1 - ambient_effect), 0.1, delta1);
  filtered_delta2 = delta2.updateEstimate(delta2, 0.1 * (1 - ambient_effect), 0.1, delta2);
  filtered_delta3 = delta3.updateEstimate(delta3, 0.1, 0.1, delta3);
